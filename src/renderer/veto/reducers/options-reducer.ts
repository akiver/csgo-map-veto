...
import {
  ...
  OPTIONS_UPDATE_TEAM_ONE_NAME,
} from 'renderer/veto/actions/update-team-one-name'
import {
  UpdateTeamTwoNameAction,
  OPTIONS_UPDATE_TEAM_TWO_NAME,
} from 'renderer/veto/actions/update-team-two-name'
import {
...
import {
  OPTIONS_TOGGLE_MAP_SELECTION,
  ToggleMapSelectionAction,
} from 'renderer/veto/actions/toggle-map-selection'
